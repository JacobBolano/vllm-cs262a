...
launch_disagg_prefill() {
  ...
  CUDA_VISIBLE_DEVICES=0 python3 \
    ...
    --kv-transfer-config \
    '{"kv_connector":"PyNcclConnector","kv_role":"kv_producer","kv_rank":0,"kv_parallel_size":4,"kv_buffer_size":5e9}' &
    ...
    --gpu-memory-utilization 0.6 \
    --kv-transfer-config \
    '{"kv_connector":"PyNcclConnector","kv_role":"kv_producer","kv_rank":1,"kv_parallel_size":4,"kv_buffer_size":5e9}' &
  ...
  CUDA_VISIBLE_DEVICES=2 python3 \
    ...
    --gpu-memory-utilization 0.6 \
    --kv-transfer-config \
    '{"kv_connector":"PyNcclConnector","kv_role":"kv_producer","kv_rank":2,"kv_parallel_size":4,"kv_buffer_size":5e9}' &
    ...
    --gpu-memory-utilization 0.6 \
    --kv-transfer-config \
    '{"kv_connector":"PyNcclConnector","kv_role":"kv_consumer","kv_rank":3,"kv_parallel_size":4,"kv_buffer_size":5e9}' &
