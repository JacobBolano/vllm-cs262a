...
prefill_servers = itertools.cycle(['http://localhost:8100/v1/completions', 
                                  'http://localhost:8101/v1/completions'])
decode_servers = itertools.cycle(['http://localhost:8200/v1/completions'])
...
async def handle_request():
    try:
        ...
        # finish prefill
        async for _ in forward_request(prefill_server, prefill_request):
            continue
