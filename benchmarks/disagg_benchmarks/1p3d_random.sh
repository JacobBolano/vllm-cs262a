...
main() {
  ...
  rm -rf 1p3d_results_50req_8qps_newRatio
  mkdir 1p3d_results_50req_8qps_newRatio
    ...
    for pair in "${input_output_pairs[@]}"; do
      ...
      for num_reqs in 50; do
        ...
        # if [ $counter -gt $start_point ]; then
          ...
          benchmark $qps $output_len_i gloo "./1p3d_results_50req_8qps_newRatio" $input_len_i $num_reqs
          kill_gpu_processes
          sleep 5
        # else
