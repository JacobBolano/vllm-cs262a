...
main() {
  ...
  for max_token in 2048 4096 16384 ; do  #2048 4096 16384
  launch_chunked_prefill $max_token 8100 8200 8300 8400
  rm -rf "./sharegpt_results_${max_token}_jacob_out:1000"
  mkdir "./sharegpt_results_${max_token}_jacob_out:1000"
  for qps in 14 ; do  # 8 14
  benchmark $qps $default_output_len chunked_prefill "./sharegpt_results_${max_token}_jacob_out:1000"
  done
  kill_gpu_processes
  done
