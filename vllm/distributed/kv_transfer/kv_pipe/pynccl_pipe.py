...
#             self.target_rank_for_recv = 0
#         elif self.kv_rank == 2:
#             self.target_rank_for_send = 3
#             self.target_rank_for_recv = 3
#         elif self.kv_rank == 3:
#             self.target_rank_for_send = 2
#             self.target_rank_for_recv = 2
...
#     def send_tensor(self, tensor: Optional[torch.Tensor], target_rank = None) -> None:
#         """
...
#     def recv_tensor(self, sourceRank = None) -> Optional[torch.Tensor]:
#         """
...
#         if sourceRank:
#             self.target_rank_for_recv = sourceRank
